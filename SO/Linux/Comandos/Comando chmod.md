El comando `chmod` es una utilidad de la línea de comandos en sistemas Unix y Linux que se utiliza para cambiar los permisos de archivos y directorios. La palabra "chmod" es una abreviatura de "change mode".
